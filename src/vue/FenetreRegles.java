...
public class FenetreRegles extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.setFont(new Font("TimesRoman",Font.PLAIN, 25));
        g2.drawString("Stroop",50,220);
        g2.setFont(new Font("TimesRoman",Font.PLAIN, 14));
        g2.drawString("Ecrivez la couleur du mot qui est ecrit. Appuyer sur backspace pour effacer votre mot," ,5,250);
        g2.drawString("appuyer sur entrer pour valider le mot, echap pour quitter une fois que la fin du jeu a lieu." ,5,300);
        g2.setFont(new Font("TimesRoman",Font.PLAIN, 25));
        g2.drawString("GuitarHero",50,370);
        g2.setFont(new Font("TimesRoman",Font.PLAIN, 14));
        g2.drawString("Appuyer sur la touche correspondant a la 1er lettre de la couleur de la barre quand elles sont" ,5,400);
        g2.drawString("sur la ligne d'arrivée. " ,5,450);
